...
/**
 * Created by suli690 on 2017/6/1.
 * 定位SDK封装
 */

public class LocationWrapper implements ILocation {
  private final static String TAG = LocationWrapper.class.getSimpleName();

  private LocationClient mLocationClient = null;
  private BDLocationListener mMyLocationListener = new MyLocationListener();

  public LocationWrapper(Context applicationContext) {
    mLocationClient = new LocationClient(applicationContext.getApplicationContext());
